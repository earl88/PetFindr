...
knitr::include_graphics("pres_images/petfinder-website.PNG")
knitr::include_graphics("FinalPresentation/")
```
...
knitr::include_graphics("pres_images/petfinder-for-developers.PNG")
```
