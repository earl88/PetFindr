...
* If the API returns an error, an informative message will be printed in an HTTP response.
...
* Example:
  + Invalid API key/secret/token (ERR-401)
  + Missing/invalid parameters in requests (ERR-00001)
