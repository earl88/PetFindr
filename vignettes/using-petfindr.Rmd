...
```{r, echo = T, eval = F}
pf_list_breeds(token, type = "rabbit")
```

```{r out.width = "80%", eval = F, echo = F}
knitr::include_graphics("https://raw.githubusercontent.com/earl88/PetFindr/master/inst/FinalPresentation/images/bunnies.png")
```
