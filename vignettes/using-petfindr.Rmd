...
Input arguments are listed as below.

- token: An access token that is generated every hour. 
- type : The type(s) of animals to be found.
- breed: The breed(s) of animals
- size : The size(s) of animals to be found (small, medium, large and xlarge). 
- gender: The gender(s) of animals to be found (male, female, and unknown). 
- age: The age(s) of animals to be found. 
- color: The color(s) of animals to be found. \
A full list of animal types, along with their respective coat and color options, can be found by running pf_list_types(token).
- coat: The coat(s) of animals to be found. \
A full list of animal types, along with their respective coat and color options, can be found by running pf_list_types(token).
- status: The adoption status of animals to be found (adoptable, adopted or found)
- organization: The organization(s) associated with animals to be found. Values should be provided as identification numbers. 
- location: The location of animals to be found. \
Values can be specified as "City, State", "latitude, longitude", or "zipcode".
- distance : The distance, in miles, from the provided location to find animals. \
Note that location has to be specified to use distance.
...
- address.city: City information of the organization
- address.state: State information of the organization
- address.postcode: Zipcode information of the organization
- address.country: Country information of the organization
- url: Petfinder website of the organization
